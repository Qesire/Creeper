...
_DISCOVERY_COUNTER_FIELDS = {
    ...
    "root_query_metadata_accepted": "discovery_root_query_metadata_accepted",
    "root_query_metadata_held": "discovery_root_query_metadata_held",
    "root_query_metadata_rejected": "discovery_root_query_metadata_rejected",
