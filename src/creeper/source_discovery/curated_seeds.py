...
def curated_non_snapshot_roots() -> tuple[SourceCandidate, ...]:
    ...
    These roots enumerate monthly raw mailbox shards.  Exact YYYY-MM child
    shards bind extracted URLs to a target-period observation month and are
    therefore eligible for direct hostname-year evidence.  The catalog roots
    themselves grant no evidence authority.
    """
    ...
    return (
        ...
        SourceCandidate(
            canonical_entrypoint="https://lists.gnu.org/archive/mbox/swarm-support/",
            source_family="HISTORICAL_MAILBOX_CATALOG",
            level=SourceLevel.METASOURCE,
            discovered_by="curated-live-research",
            discovery_strategy="CURATED_NON_SNAPSHOT_SEARCH",
        ...
        SourceCandidate(
            canonical_entrypoint="https://lists.gnu.org/archive/mbox/help-octave/",
            source_family="HISTORICAL_MAILBOX_CATALOG",
            level=SourceLevel.METASOURCE,
            discovered_by="curated-live-research",
            discovery_strategy="CURATED_NON_SNAPSHOT_SEARCH",
