"""HTTPX transport that fences each provider attempt with an Authority permit."""
...
PermitReport = Callable[[object, int | None, httpx.Headers | None, int], Awaitable[None]]
...
def build_authority_transport(
    *,
    ...
    return AuthorityPermitTransport(inner, acquire=acquire, report=report)
