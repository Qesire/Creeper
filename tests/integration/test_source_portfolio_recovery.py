...
class SourcePortfolioRecoveryIntegrationTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_production_starvation_fixture_recovers_source_portfolio(self) -> None:
        ...
        # With ordinary LLM refill removed, deterministic background recovery
        # is no longer deferred by a synthetic foreground agent-search cycle.
        self.assertEqual(search_strategies, [])
