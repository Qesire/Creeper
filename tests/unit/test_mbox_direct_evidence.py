...
from creeper.sources.production import MboxMessageProductionAdapter
...
class GnuMboxDirectEvidenceTests(unittest.TestCase):
    ...
    def test_production_emits_direct_capsule_with_message_date_and_url(self) -> None:
        payload = mbox_message(
            "Wed, 25 Mar 1998 10:38:28 -0600",
        ...
        self.assertEqual(observation.original_url, "https://direct.example/path")
        self.assertIn("25 Mar 1998", observation.source_time or "")
        self.assertEqual(
            observation.evidence_contract_id,
            GNU_MBOX_DIRECT_CONTRACT.contract_id,
        )
        ...
        self.assertIn(":message:0", capsule.record_locator)
